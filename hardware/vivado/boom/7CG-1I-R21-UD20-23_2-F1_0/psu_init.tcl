...
set psu_clock_init_data {
    ...
    #  usually an issue, but designers must be aware.)
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E00C8, 0x013F3F07U ,0x01010C00U)  */
    mask_write 0XFF5E00C8 0x013F3F07 0x01010C00
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x00000240
		...
		#(OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B0327FU)  */
    mask_write 0XFF180208 0xFFFFFFFF 0x00B0327F
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF260000 0x00000001 0x00000001
		...
		# PSU_GPIO_DIRM_1_DIRECTION_1                                                     0x10000

		# Direction mode (GPIO Bank1, MIO)
		#(OFFSET, MASK, VALUE)      (0XFF0A0244, 0x03FFFFFFU ,0x00010000U)  */
    mask_write 0XFF0A0244 0x03FFFFFF 0x00010000
		# : DIR MODE BANK 2
		...
		# PSU_GPIO_OEN_1_OP_ENABLE_1                                                      0x10000

		# Output enable (GPIO Bank1, MIO)
		#(OFFSET, MASK, VALUE)      (0XFF0A0248, 0x03FFFFFFU ,0x00010000U)  */
    mask_write 0XFF0A0248 0x03FFFFFF 0x00010000
		...
		# PSU_GPIO_MASK_DATA_1_MSW_MASK_1_MSW                                             0x3fe

		# Operation is the same as MASK_DATA_0_LSW[DATA_0_LSW]
		# PSU_GPIO_MASK_DATA_1_MSW_DATA_1_MSW                                             0x1

		# Maskable Output Data (GPIO Bank1, MIO, Upper 10 bits)
		#(OFFSET, MASK, VALUE)      (0XFF0A000C, 0x03FF03FFU ,0x03FE0001U)  */
    mask_write 0XFF0A000C 0x03FF03FF 0x03FE0001
    ...
    mask_delay 0x00000000 1
		...
		# Maskable Output Data (GPIO Bank1, MIO, Upper 10 bits)
		#(OFFSET, MASK, VALUE)      (0XFF0A000C, 0x03FF03FFU ,0x03FE0000U)  */
    mask_write 0XFF0A000C 0x03FF03FF 0x03FE0000
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5 MS DELAY
    ...
    # pin within the 32-bit bank
		# PSU_GPIO_DIRM_0_DIRECTION_0                                                     0x2

		# Direction mode (GPIO Bank0, MIO)
		#(OFFSET, MASK, VALUE)      (0XFF0A0204, 0x03FFFFFFU ,0x00000002U)  */
    mask_write 0XFF0A0204 0x03FFFFFF 0x00000002
		# : DIR MODE BANK 1
		# : DIR MODE BANK 2
		# : OUTPUT ENABLE BANK 0
    ...
    # ing pin within the 32-bit bank
		# PSU_GPIO_OEN_0_OP_ENABLE_0                                                      0x2

		# Output enable (GPIO Bank0, MIO)
		#(OFFSET, MASK, VALUE)      (0XFF0A0208, 0x03FFFFFFU ,0x00000002U)  */
    mask_write 0XFF0A0208 0x03FFFFFF 0x00000002
		# : OUTPUT ENABLE BANK 1
		# : OUTPUT ENABLE BANK 2
		# : MASK_DATA_0_LSW LOW BANK [15:0]
    ...
    # ols the corresponding pin within the 16-bit half-bank. Reads return 0's.
		# PSU_GPIO_MASK_DATA_0_LSW_MASK_0_LSW                                             0xfffd
    ...
    # :0]. Reads do not return the value on the GPIO pin.
		# PSU_GPIO_MASK_DATA_0_LSW_DATA_0_LSW                                             0x2

		# Maskable Output Data (GPIO Bank0, MIO, Lower 16bits)
		#(OFFSET, MASK, VALUE)      (0XFF0A0000, 0xFFFFFFFFU ,0xFFFD0002U)  */
    mask_write 0XFF0A0000 0xFFFFFFFF 0xFFFD0002
		# : MASK_DATA_0_MSW LOW BANK [25:16]
		# : MASK_DATA_1_LSW LOW BANK [41:26]
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
    ...
    # :0]. Reads do not return the value on the GPIO pin.
		...
		# Maskable Output Data (GPIO Bank0, MIO, Lower 16bits)
		#(OFFSET, MASK, VALUE)      (0XFF0A0000, 0xFFFFFFFFU ,0xFFFD0000U)  */
    mask_write 0XFF0A0000 0xFFFFFFFF 0xFFFD0000
		# : MASK_DATA_0_MSW LOW BANK [25:16]
		# : MASK_DATA_1_LSW LOW BANK [41:26]
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
