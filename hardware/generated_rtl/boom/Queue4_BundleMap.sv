...
module Queue4_BundleMap(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  input        clock,	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  input        reset,	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  output       io_enq_ready,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input        io_enq_valid,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input  [6:0] io_enq_bits_extra_id,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input        io_enq_bits_real_last,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input        io_deq_ready,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output       io_deq_valid,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  output [6:0] io_deq_bits_extra_id,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  ram_4x8 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_real_last, io_enq_bits_extra_id})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_extra_id = _ram_ext_R0_data[6:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_real_last = _ram_ext_R0_data[7];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
