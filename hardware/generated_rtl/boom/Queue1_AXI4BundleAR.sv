...
module Queue1_AXI4BundleAR(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [6:0]  io_enq_bits_echo_extra_id,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [6:0]  io_deq_bits_echo_extra_id	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
);
  ...
  always @(posedge clock) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35, :263:27, :298:17, :301:{26,35}]
      ram <= {io_enq_bits_echo_extra_id, io_enq_bits_qos, io_enq_bits_prot, io_enq_bits_cache, io_enq_bits_lock, io_enq_bits_burst, io_enq_bits_size, io_enq_bits_len, io_enq_bits_addr, io_enq_bits_id};	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_addr = full ? ram[32:1] : io_enq_bits_addr;	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27, :293:17, :298:17, :299:19]
  ...
  assign io_deq_bits_echo_extra_id = full ? ram[64:58] : io_enq_bits_echo_extra_id;	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :259:27, :293:17, :298:17, :299:19]
endmodule
