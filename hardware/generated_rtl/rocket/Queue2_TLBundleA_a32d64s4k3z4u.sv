...
module Queue2_TLBundleA_a32d64s4k3z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input         io_enq_bits_user_amba_prot_bufferable,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input         io_enq_bits_user_amba_prot_modifiable,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input         io_enq_bits_user_amba_prot_readalloc,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  input         io_enq_bits_user_amba_prot_writealloc,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  input         io_enq_bits_user_amba_prot_fetch,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  wire [125:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x126 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_user_amba_prot_fetch, io_enq_bits_user_amba_prot_secure, io_enq_bits_user_amba_prot_privileged, io_enq_bits_user_amba_prot_writealloc, io_enq_bits_user_amba_prot_readalloc, io_enq_bits_user_amba_prot_modifiable, io_enq_bits_user_amba_prot_bufferable, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, 3'h0, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :255:14, :256:91]
  ...
  assign io_deq_bits_user_amba_prot_bufferable = _ram_ext_R0_data[46];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_modifiable = _ram_ext_R0_data[47];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_readalloc = _ram_ext_R0_data[48];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_writealloc = _ram_ext_R0_data[49];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_privileged = _ram_ext_R0_data[50];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_secure = _ram_ext_R0_data[51];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_user_amba_prot_fetch = _ram_ext_R0_data[52];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = _ram_ext_R0_data[60:53];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[124:61];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[125];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
